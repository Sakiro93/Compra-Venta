...
Public Class Servicio
    ...
    Public Sub cargar(ByVal Buscar As String)
        Dg.Rows.Clear()
        For Each ser In Logicadatos.buscarSer(Buscar)
            Dg.Rows.Add(ser.ser_ID, ser.ser_Descripcion, ser.ser_Precio)
        Next
    End Sub
    ...
    Private Sub BtnGuardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnGuardar.Click
        Dim datos = New EntServicio(Cod, TxtDescripcion.Text, TxtPrecio.Text)
        If MessageBox.Show("¿Desea guardar estos datos en el Sistema?", "Sistema de Compra y Venta", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.Yes Then
            If Validacion.ValidaEntrada(ErrDatos, GrupCliDatos) Then
                If grabarG = "N" Then
                    Logicadatos.ingresarSer(datos)
                Else
                    Logicadatos.modificarSer(datos)
                End If
                limpiar()
    ...
    Public Sub MostrarDatos(ByVal i As Integer)
        ...
        TxtPrecio.Text = Dg.Rows(i).Cells(2).Value.ToString
    ...
    Private Sub TxtPrecio_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles TxtPrecio.KeyPress
        Validacion.ValidarPrecio(e, TxtPrecio)
    End Sub
End Class